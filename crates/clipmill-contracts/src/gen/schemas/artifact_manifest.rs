...
#[doc = "    },"]
#[doc = "    \"recipe\": {"]
#[doc = "      \"description\": \"Additive W3 cache-key metadata. Required for new daemon commits; omitted legacy v1 manifests remain readable by artifact id but cannot prove a computed cache hit.\","]
#[doc = "      \"type\": \"object\","]
#[doc = "      \"required\": ["]
#[doc = "        \"config\","]
#[doc = "        \"key_version\","]
#[doc = "        \"semantic_version\""]
#[doc = "      ],"]
#[doc = "      \"properties\": {"]
#[doc = "        \"config\": {"]
#[doc = "          \"description\": \"Stage configuration canonicalized with RFC 8785 before hashing.\","]
#[doc = "          \"type\": \"object\""]
#[doc = "        },"]
#[doc = "        \"key_version\": {"]
#[doc = "          \"const\": \"clipmill.artifact.key.v1\""]
#[doc = "        },"]
#[doc = "        \"semantic_version\": {"]
#[doc = "          \"description\": \"Schema/runtime semantic version included in the artifact key.\","]
#[doc = "          \"type\": \"string\","]
#[doc = "          \"maxLength\": 128,"]
#[doc = "          \"minLength\": 1,"]
#[doc = "          \"pattern\": \"^[^\\\\u0000-\\\\u001f\\\\u007f]+$\""]
...
pub struct ArtifactManifest {
    ...
    pub recipe: ::std::option::Option<ArtifactManifestRecipe>,
...
#[doc = "Additive W3 cache-key metadata. Required for new daemon commits; omitted legacy v1 manifests remain readable by artifact id but cannot prove a computed cache hit."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[derive(:: serde :: Deserialize, :: serde :: Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct ArtifactManifestRecipe {
    #[doc = "Stage configuration canonicalized with RFC 8785 before hashing."]
    pub config: ::serde_json::Map<::std::string::String, ::serde_json::Value>,
    pub key_version: ::serde_json::Value,
    #[doc = "Schema/runtime semantic version included in the artifact key."]
    pub semantic_version: ArtifactManifestRecipeSemanticVersion,
}
impl ArtifactManifestRecipe {
    pub fn builder() -> builder::ArtifactManifestRecipe {
        Default::default()
    }
}
#[doc = "Schema/runtime semantic version included in the artifact key."]
...
#[derive(:: serde :: Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct ArtifactManifestRecipeSemanticVersion(::std::string::String);
impl ::std::ops::Deref for ArtifactManifestRecipeSemanticVersion {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<ArtifactManifestRecipeSemanticVersion> for ::std::string::String {
    fn from(value: ArtifactManifestRecipeSemanticVersion) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for ArtifactManifestRecipeSemanticVersion {
    type Err = self::error::ConversionError;
    fn from_str(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl ::std::convert::TryFrom<&str> for ArtifactManifestRecipeSemanticVersion {
    type Error = self::error::ConversionError;
    fn try_from(value: &str) -> ::std::result::Result<Self, self::error::ConversionError> {
        value.parse()
    }
}
impl ::std::convert::TryFrom<&::std::string::String> for ArtifactManifestRecipeSemanticVersion {
    type Error = self::error::ConversionError;
    fn try_from(
        value: &::std::string::String,
    ) -> ::std::result::Result<Self, self::error::ConversionError> {
...
impl<'de> ::serde::Deserialize<'de> for ArtifactManifestRecipeSemanticVersion {
    fn deserialize<D>(deserializer: D) -> ::std::result::Result<Self, D::Error>
    where
        D: ::serde::Deserializer<'de>,
    {
...
pub mod builder {
    ...
    pub struct ArtifactManifest {
        ...
        quality: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        recipe: ::std::result::Result<
            ::std::option::Option<super::ArtifactManifestRecipe>,
            ::std::string::String,
        >,
    ...
    impl ArtifactManifest {
        ...
        pub fn recipe<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::std::option::Option<super::ArtifactManifestRecipe>>,
            T::Error: ::std::fmt::Display,
        {
            self.recipe = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for recipe: {e}"));
            self
        }
    ...
    pub struct ArtifactManifestRecipe {
        config: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        key_version: ::std::result::Result<::serde_json::Value, ::std::string::String>,
        semantic_version: ::std::result::Result<
            super::ArtifactManifestRecipeSemanticVersion,
            ::std::string::String,
        >,
    }
    impl ::std::default::Default for ArtifactManifestRecipe {
        fn default() -> Self {
            Self {
                config: Err("no value supplied for config".to_string()),
                key_version: Err("no value supplied for key_version".to_string()),
                semantic_version: Err("no value supplied for semantic_version".to_string()),
            }
        }
    }
    impl ArtifactManifestRecipe {
        ...
        pub fn key_version<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<::serde_json::Value>,
            T::Error: ::std::fmt::Display,
        {
            self.key_version = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for key_version: {e}"));
            self
        }
        pub fn semantic_version<T>(mut self, value: T) -> Self
        where
            T: ::std::convert::TryInto<super::ArtifactManifestRecipeSemanticVersion>,
            T::Error: ::std::fmt::Display,
        {
            self.semantic_version = value
                .try_into()
                .map_err(|e| format!("error converting supplied value for semantic_version: {e}"));
            self
        }
    }
    impl ::std::convert::TryFrom<ArtifactManifestRecipe> for super::ArtifactManifestRecipe {
        type Error = super::error::ConversionError;
        fn try_from(
            value: ArtifactManifestRecipe,
        ) -> ::std::result::Result<Self, super::error::ConversionError> {
            Ok(Self {
                config: value.config?,
    ...
    impl ::std::convert::From<super::ArtifactManifestRecipe> for ArtifactManifestRecipe {
        fn from(value: super::ArtifactManifestRecipe) -> Self {
            Self {
                config: Ok(value.config),
                key_version: Ok(value.key_version),
                semantic_version: Ok(value.semantic_version),
            }
        }
    }
    #[derive(Clone, Debug)]
