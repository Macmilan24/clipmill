...
from clipmill_worker_asr_whispercpp.batching import decode_windows
...
def main() -> int:
    ...
    print(
        ...
        f"{len(first['utterances'])} utterances, median timing error "
        f"{first['median_error_ms']:.0f} ms against a {TIMING_BAR_MS} ms bar, "
